...
export interface ApiSurveySubmissionSurveySubmission
  ...
  attributes: {
    completion: Schema.Attribute.BigInteger;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    org: Schema.Attribute.Component<'org.org-info', false>;
    publishedAt: Schema.Attribute.DateTime;
    redFlags: Schema.Attribute.BigInteger;
    results: Schema.Attribute.Component<'survey.result-item', true>;
    score: Schema.Attribute.Component<'survey.score', false>;
